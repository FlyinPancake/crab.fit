...
const hasAvailability = (event: RecentEvent): event is Required<RecentEvent> =>
          ...
          {recents.map((recent) => (
            ...
            >
              <input
                ...
                value={recent.id}
                id={recent.id}
                onChange={() => setSelected(recent.id)}
                checked={selected === recent.id}
              />
              <label htmlFor={recent.id} className={styles.name}>
                <span>
                  {recent.name} ({recent.user.name})
                </span>
